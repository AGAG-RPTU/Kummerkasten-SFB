...
const STRINGS = {
  en: {
    ...
    'setup.id': 'User name',
    'setup.idHint': 'Must be unique among the trusted persons and cannot be changed later, because it is part of your key. Allowed: lowercase letters a–z, digits 0–9 and _, starting with a letter, at most 32 characters. For example your first name (erika) or first and last name (erika_mustermann).',
    'setup.idTaken': 'This user name is taken. Use it only if it is yours and you are changing your passphrase.',
    'setup.rotate': 'Changing your passphrase: create a new key here with your existing user name and send the entry. Once it has replaced your old one, log in with the new passphrase; the page then asks once for the previous one, to take over your conversations.',
    ...
    'err.id': 'The user name must start with a lowercase letter and contain only a–z, 0–9 and _, at most 32 characters.',
  ...
  de: {
    ...
    'setup.id': 'Benutzername',
    'setup.idHint': 'Muss unter den Vertrauenspersonen eindeutig sein und lässt sich später nicht ändern, weil er in deinen Schlüssel eingeht. Erlaubt: Kleinbuchstaben a–z, Ziffern 0–9 und _, beginnend mit einem Buchstaben, höchstens 32 Zeichen. Zum Beispiel dein Vorname (erika) oder Vor- und Nachname (erika_mustermann).',
    'setup.idTaken': 'Dieser Benutzername ist vergeben. Verwende ihn nur, wenn es deiner ist und du deine Passphrase wechselst.',
    'setup.rotate': 'Passphrase wechseln: Erzeuge hier einen neuen Schlüssel mit deinem bisherigen Benutzernamen und schick den Eintrag. Sobald er deinen alten ersetzt hat, melde dich mit der neuen Passphrase an; die Seite fragt dann einmal nach der früheren, um deine Unterhaltungen zu übernehmen.',
    ...
    'err.id': 'Der Benutzername muss mit einem Kleinbuchstaben beginnen und darf nur a–z, 0–9 und _ enthalten, höchstens 32 Zeichen.',
