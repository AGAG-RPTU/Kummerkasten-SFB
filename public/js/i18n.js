...
const STRINGS = {
  en: {
    ...
    'words.recognisedCount': 'Recognised {n} of {total} words',
    'words.unknownCount': 'Words not recognised: {n}',
    'conv.you': 'You',
    ...
    'err.rate': 'Too many new conversations on the site right now. Please try again in an hour.',
  ...
  de: {
    ...
    'words.recognisedCount': '{n} von {total} Wörtern erkannt',
    'words.unknownCount': 'Nicht erkannte Wörter: {n}',
    'conv.you': 'Du',
    ...
    'err.rate': 'Gerade werden zu viele neue Unterhaltungen begonnen. Bitte in einer Stunde erneut versuchen.',
