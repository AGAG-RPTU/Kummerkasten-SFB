...
const STRINGS = {
  en: {
    ...
    'setup.format': 'The words are separated by single spaces. When you enter it later, case and separators do not matter, and the first three letters of each word are enough.',
  ...
  de: {
    ...
    'setup.format': 'Die Wörter sind durch einzelne Leerzeichen getrennt. Bei der späteren Eingabe spielen Groß- und Kleinschreibung und Trennzeichen keine Rolle, und die ersten drei Buchstaben jedes Worts genügen.',
