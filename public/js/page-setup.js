...
import { $, h, status, nextPaint, attachWordFeedback } from './ui.js';
...
$('generate').addEventListener('click', async () => {
  ...
  $('passphrase').replaceChildren(...passphrase.split(' ').map((w) => h('li', {}, w)));
...
// Retyping proves the passphrase was saved before any key is published.
