...
// Also the logo's link in pages/layout.html.
const SFB_URL = 'https://www.computeralgebra.de/sfb/';
...
export function initPage() {
  ...
  setGlobals({ sourceUrl: SOURCE_URL, securityUrl: SECURITY_URL, sfbUrl: SFB_URL });
  applyI18n();
